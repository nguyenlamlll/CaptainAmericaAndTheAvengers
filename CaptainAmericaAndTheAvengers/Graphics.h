...
public:
	...
	ID3DXFont* loadDirectXFont(std::string fontName, int fontHeight, bool isItalic);
	...
	void spriteBegin()
	{
		sprite->Begin(D3DXSPRITE_ALPHABLEND | D3DXSPRITE_SORT_DEPTH_BACKTOFRONT | D3DXSPRITE_DONOTSAVESTATE);
	}
