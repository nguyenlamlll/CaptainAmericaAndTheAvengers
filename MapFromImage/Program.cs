    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var item in allOriginalTiles)
            {
                ...
                {
                    if (AreTwoBitMapsTheSame(item, uniqueTile.Value))
                    {
                        isThisItemANewUniqueTile = false;
                        tileId = uniqueTile.Key;
                        break;
                    }
                }
            ...
            mapData.Tileset.Column = uniqueTiles.Count;
